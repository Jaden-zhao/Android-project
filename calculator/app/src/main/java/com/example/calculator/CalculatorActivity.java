...
public class CalculatorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculator); //从layout布局中获取名为calculator的布局文件。

        tv_marquee = findViewById(R.id.tv_marquee);//找到滚动文本视图
        tv_marquee.setSelected(true);

        tv_result = findViewById(R.id.tv_result);//找到ID为tv_result的视图，也就是“简单计算器”
    ...
    public void onClick(View v){
        ...
        if (resid == R.id.ib_sqrt) { // 如果是开根号按钮
            inputText = "√"; //那么就把√字符放到inputText变量里
        }
        else {
